...
#         elif args.script == 4:
#             subprocess.run(
#                 ["python3", "../Questions/Which_game_had_won_the_most_awards_in_2022/MostAwardsByCategory.py"])
#             print("\t")
#             subprocess.run(["python3", "../Questions/Which_game_had_won_the_most_awards_in_2022/MostAwardsInTotal.py"])
#         elif args.script == 5:
#             subprocess.run(["python3", "missing"])
#         elif args.script == 6:
#             subprocess.run(["python3",
...
#         elif args.script == 8:
#             subprocess.run(["python3", "helloworld.py"])
#         elif args.script == 9:
#             subprocess.run(["python3", "calculate.py"])